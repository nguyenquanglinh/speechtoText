...
def create_flags():
    ...
    f.DEFINE_string('train_files', '/media/linhnguyen/93d25d45-9328-487b-a68e-01c7e2691234/code/PycharmProjects/DeepSpeech/LinhNQ/audio_book/audiobooks_train.csv',
    ...
    f.DEFINE_string('dev_files', '/media/linhnguyen/93d25d45-9328-487b-a68e-01c7e2691234/code/PycharmProjects/DeepSpeech/LinhNQ/audio_book/audiobooks_dev.csv',
    ...
    f.DEFINE_string('read_buffer', '20GB',
    ...
    f.DEFINE_integer('cache_for_epochs', 0,
    ...
    f.DEFINE_multi_string('augment', None,
                          'specifies an augmentation of the training samples. Format is "--augment operation[param1=value1, ...]"')

    # Global Constants
    # ================

    f.DEFINE_integer('epochs', 30, 'how many epochs (complete runs through the train files) to train for')
    ...
    # Batch sizes
    f.DEFINE_integer('train_batch_size', 128, 'number of elements in a training batch')
    ...
    f.DEFINE_boolean('use_allow_growth', False,
    ...
    f.DEFINE_string('checkpoint_dir', '',
                    'directory from which checkpoints are loaded and to which they are saved - defaults to directory "deepspeech/checkpoints" within user\'s data home specified by the XDG Base Directory Specification')
    f.DEFINE_string('load_checkpoint_dir', '',
    ...
    f.DEFINE_string('save_checkpoint_dir', '',
                    'directory to which checkpoints are saved - defaults to directory "deepspeech/checkpoints" within user\'s data home specified by the XDG Base Directory Specification')
    ...
    f.DEFINE_string('load_train', 'auto',
    ...
    f.DEFINE_string('load_evaluate', 'auto',
    ...
    f.DEFINE_string('export_dir', '/media/linhnguyen/93d25d45-9328-487b-a68e-01c7e2691234/code/PycharmProjects/DeepSpeech/LinhNQ/export_dir',
    ...
    f.DEFINE_string('export_file_name', 'LinhNQb', 'name for the exported model file name')
    f.DEFINE_integer('export_beam_width', 500, 'default beam width to embed into exported graph')

    # Model metadata

    f.DEFINE_string('export_author_id', 'author',
    ...
    f.DEFINE_string('export_model_version', '0.0.1',
                    'semantic version of the exported model. See https://semver.org/. This is fully controlled by you as author of the model and has no required connection with DeepSpeech versions')

    def str_val_equals_help(name, val_desc):
        f.DEFINE_string(name, '<{}>'.format(val_desc), val_desc)

    str_val_equals_help('export_contact_info',
    ...
    str_val_equals_help('export_license',
    ...
    str_val_equals_help('export_language',
    ...
    str_val_equals_help('export_min_ds_version',
                        'minimum DeepSpeech version (inclusive) the exported model is compatible with')
    str_val_equals_help('export_max_ds_version',
                        'maximum DeepSpeech version (inclusive) the exported model is compatible with')
    str_val_equals_help('export_description',
    ...
    #create data
    f.DEFINE_boolean('create_file_audio_book_csv', True,
    ...
    f.DEFINE_string('test_output_file', '/media/linhnguyen/93d25d45-9328-487b-a68e-01c7e2691234/code/PycharmProjects/DeepSpeech/LinhNQ/test_output_file/test_output_file.json',
    ...
    f.DEFINE_boolean('layer_norm', False,
    ...
    f.DEFINE_float('es_min_delta', 0.05,
    ...
    f.DEFINE_boolean('bytes_output_mode', False,
    ...
    f.DEFINE_string('alphabet_config_path', '/media/linhnguyen/93d25d45-9328-487b-a68e-01c7e2691234/code/PycharmProjects/DeepSpeech/data/alphabet_VN.txt',
